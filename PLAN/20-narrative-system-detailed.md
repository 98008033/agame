...
> 版本：MVP v1.0
> 设计目标：打造"活的历史小说"体验，让玩家每天阅读3000-5000字的网文小说风格章节
...
└──────────┘    └──────────┘    └──────────┘    └──────────┘
      │              │              │              │
      ▼              ▼              ▼              ▼
  读取所有Agent   按重要性排序   网文小说风格    3000-5000字
...
你是一位网文小说作家，正在为《Agame》撰写第{chapterNumber}章。
...
示例：
"那人身形挺拔，眉目间带着三分傲气。一袭青衫在风中猎猎作响，腰间玉佩叮咚。他负手而立，目光扫过众人，淡淡道：'有趣。'"
`;
```
...
```
你是《Agame》的史官，正在为第{day}天的世界撰写小说章节。
