...
> **核心定位**：每天阅读一本正在书写的网文小说——而你也是故事中的一员，你的选择会改变剧情走向。
...
| [17-visual-style-guide.md](PLAN/17-visual-style-guide.md) | **视觉风格指南**（像素奇幻风+色彩系统+UI规范） | ✅ |
...
- 每日生成3000-5000字**网文风格**小说章节
- "实时造英雄"：四国各1个主角NPC，实时生成传记
- **你的选择改变小说**：玩家决策被记录进小说，真正影响剧情
...
- **16-bit像素艺术** + 奇幻魔法元素
- 主色调：深空黑 `#1A1A2E`、羊皮纸 `#F4E4C1`、四阵营魔法色
- 参考：《最终幻想6》《星露谷物语》《八方旅人》
...
Agame：世界 → 自动运转 → 产生故事 → 玩家阅读/参与 → 故事继续
```
